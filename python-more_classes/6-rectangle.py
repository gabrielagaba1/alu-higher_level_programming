#!/usr/bin/python3
"""Module that defines a Rectangle class with number_of_instances."""
...
class Rectangle:
    ...
    character, to return an evaluable string representation, to
    print a message when an instance is deleted, and it keeps track
    of how many instances currently exist.
    """
