...
class Square:
    ...
    through a property getter and setter. The class also provides
    a method to compute the area and a method to print the square
    using the '#' character.
    """
    ...
    def my_print(self):
        ...
        If the size is 0, an empty line is printed instead.
        """
        if self.__size == 0:
            print()
            return
